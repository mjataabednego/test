...
<!-- Mirrored from themewagon.github.io/dashtreme/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Jun 2023 21:25:41 GMT -->
...
<head>
  ...
  <!-- Vector CSS -->
  <link href="Adminassets/plugins/vectormap/jquery-jvectormap-2.0.2.html" rel="stylesheet"/>
  <!-- simplebar CSS-->
    ...
    <li class="nav-item">
      ...
      <ul class="dropdown-menu dropdown-menu-right">
       <li class="dropdown-item user-details">
        ...
        <li class="dropdown-divider"></li>
        <li class="dropdown-item"><i class="icon-power mr-2"></i><a href="{{ route('logout') }}"> Logout
...
@yield('content')
   ...
   <!-- simplebar js -->
    ...
    <!-- loader scripts -->
    <script src="Adminassets/js/jquery.loading-indicator.html"></script>
    <!-- Custom scripts -->
  ...
  <!-- Mirrored from themewagon.github.io/dashtreme/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Jun 2023 21:25:55 GMT -->
  </html>
