...
<div class="container">
    <div class="row">
        <div class="col-lg-4 mb-lg-0 mb-3">
            <div class="card p-3">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <small><span class="fw-bold">Name:</span><span>Abednego</span></small>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mb-lg-0 mb-3">
                ...
                <div class="card-body border p-0">
                    <p>
                        <a class="btn btn-primary w-100 h-100 d-flex align-items-center justify-content-between"
                            data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="true"
                            aria-controls="collapseExample">
                            <span class="fw-bold">CryptoCurrence</span>
                            <span class=""><img src="../assets/img/shape/bitcoin (2).png (2).png" alt=""></i>
                            </span>
                        </a>
                    </p>
                    <div class="collapse p-3 pt-0" id="collapseExample">
                            ...
                            <div class="col-lg-7">
                                <form action="" class="form">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="btn btn-primary w-100" id="btn1">Sumbit</div>
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="col-12">
            <div class="btn btn-primary payment" id="btn2">
                checkout
            </div>
        </div>
    </div>
